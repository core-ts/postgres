...
var PoolClientManager = (function () {
  ...
  PoolClientManager.prototype.end = function () {
    return __awaiter(this, void 0, void 0, function () {
      var e_1;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 4]);
            return [4, this.client.query("commit")];
          case 1:
            _a.sent();
            this.client.release();
            return [3, 4];
          case 2:
            e_1 = _a.sent();
            return [4, this.client.query("rollback")];
          case 3:
            _a.sent();
            this.client.release();
            throw e_1;
...
function execBatch(pool, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function () {
    var client, c, result0, subs, arrPromise, e_2, arrPromise, e_3;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
function execBatchWithClientTx(client, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function () {
    var c, result0, subs, arrPromise, e_4, arrPromise, e_5;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!statements || statements.length === 0) {
...
exports.execBatchWithClientTx = execBatchWithClientTx;
