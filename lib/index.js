...
var StringService = (function () {
  ...
  StringService.prototype.load = function (keyword, max) {
    ...
    var k = keyword + "%";
    return this.query("select " + this.field + " from " + this.table + " where " + this.field + " ilike $1 order by " + this.field + " limit " + m, [k]).then(function (res) {
      return res.map(function (i) { return i[_this.field]; });
    });
  };
