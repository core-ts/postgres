      ...
      switch (_a.label) {
        case 0:
          if (!statements || statements.length === 0) {
            ...
            return [2, execute(pool, statements[0].query, toArray(statements[0].params))];
          }
...
function executeBatchWithClient(client, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function () {
    var c, result0, subs, arrPromise, arrPromise;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!statements || statements.length === 0) {
          ...
          c = 0;
          if (!firstSuccess) return [3, 4];
          return [4, client.query(statements[0].query, toArray(statements[0].params))];
        case 1:
          result0 = _a.sent();
          if (!(result0 && result0.rowCount !== 0)) return [3, 3];
          subs = statements.slice(1);
          arrPromise = subs.map(function (item, i) {
            return client.query(item.query, item.params ? item.params : []);
          });
