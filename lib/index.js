...
var FollowRepository = (function () {
  function FollowRepository(execute, followerTable, followerId, follower, followed_at, followingTable, id, following, following_at, infoTable, infoId, followerCount) {
    this.execute = execute;
    this.followerTable = followerTable;
    this.followerId = followerId;
    this.follower = follower;
