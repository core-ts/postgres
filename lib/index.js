...
var PoolManager = (function () {
  ...
  PoolManager.prototype.beginTransaction = function () {
    return __awaiter(this, void 0, void 0, function () {
      var client, clientManager, err_1;
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            _a.sent();
            clientManager = new PoolClientManager(client);
            return [2, clientManager];
          case 4:
            err_1 = _a.sent();
            try {
              client.release();
...
var PoolClientManager = (function () {
  ...
  PoolClientManager.prototype.commit = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0: return [4, this.client.query("commit")];
          case 1:
            _a.sent();
            this.client.release();
            return [2];
  ...
  PoolClientManager.prototype.rollback = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0: return [4, this.client.query("rollback")];
          case 1:
            _a.sent();
            this.client.release();
            return [2];
  ...
  PoolClientManager.prototype.execute = function (sql, args, ctx) {
    var p = ctx ? ctx : this.client;
    return execute(this.client, sql, args);
  };
  PoolClientManager.prototype.executeBatch = function (statements, firstSuccess, ctx) {
    var p = ctx ? ctx : this.client;
  ...
  PoolClientManager.prototype.executeScalar = function (sql, args, ctx) {
    var p = ctx ? ctx : this.client;
    return executeScalar(p, sql, args);
  };
...
function execute(client, sql, args) {
  var p = toArray(args);
...
function executeScalar(client, sql, args) {
...
function count(client, sql, args) {
  return executeScalar(client, sql, args);
}
exports.count = count;
...
function executeBatchWithClientTx(client, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function () {
    var c, result0, l, j, item, res, e_1, l, j, item, res, e_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!statements || statements.length === 0) {
            ...
            return [2, execute(client, statements[0].query, statements[0].params)];
          }
          c = 0;
        ...
        case 3:
          result0 = _a.sent();
          if (!(result0 && result0.rowCount)) return [3, 9];
          c = result0.rowCount;
          l = statements.length;
          j = 1;
          _a.label = 4;
        case 4:
          if (!(j < l)) return [3, 7];
          item = statements[j];
          return [4, client.query(item.query, toArray(item.params))];
        case 5:
          res = _a.sent();
          if (res.rowCount) {
            c += res.rowCount;
        ...
        case 17:
          j++;
          return [3, 15];
        case 18: return [4, client.query("commit")];
        case 19:
          _a.sent();
          client.release();
          return [2, c];
...
exports.executeBatchWithClientTx = executeBatchWithClientTx;
function executeBatchWithClient(client, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function () {
    var c, result0, l, j, item, res, l, j, item, res;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!statements || statements.length === 0) {
          ...
          c = 0;
          if (!firstSuccess) return [3, 6];
          return [4, client.query(statements[0].query, toArray(statements[0].params))];
        case 1:
          result0 = _a.sent();
          if (!(result0 && result0.rowCount)) return [3, 5];
          c = result0.rowCount;
          l = statements.length;
          j = 1;
          _a.label = 2;
...
exports.executeBatchWithClient = executeBatchWithClient;
...
var PostgreSQLChecker = (function () {
  ...
  PostgreSQLChecker.prototype.build = function (data, error) {
    if (error) {
      return __assign({ name: this.name(), status: "DOWN", error: error.message }, data);
    }
    return __assign({ name: this.name(), status: "UP" }, data);
  };
  PostgreSQLChecker.prototype.check = function () {
    return __awaiter(this, void 0, void 0, function () {
      var start, client, err_2;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            start = Date.now();
          ...
          case 1:
            ...
            return [4, this.withTimeout(this.pool.connect(), this.timeout, "Connection timeout")];
          case 2:
            client = _a.sent();
            return [4, this.withTimeout(client.query("SELECT 1"), this.timeout, "Query timeout")];
          case 3:
            _a.sent();
            return [2, this.build({
  ...
  PostgreSQLChecker.prototype.withTimeout = function (promise, timeout, message) {
    return Promise.race([promise, new Promise(function (_, reject) { return setTimeout(function () { return reject(new Error(message)); }, timeout); })]);
  };
...
var FollowUserRepository = (function () {
  function FollowUserRepository(execute, followerTable, followerId, follower, followed_at, followingTable, id, following, following_at, infoTable, infoId, followerCount, followingCount) {
    this.execute = execute;
  ...
  FollowUserRepository.prototype.follow = function (id, target) {
    var now = new Date();
    var query1 = "insert into " + this.followerTable + "(" + this.followerId + ", " + this.follower + ", " + this.followed_at + ") values ($1, $2, $3) on conflict (" + this.followerId + ", " + this.follower + ") do nothing";
    var query2 = "insert into " + this.followingTable + "(" + this.id + ", " + this.following + ", " + this.following_at + ") values ($1, $2, $3) on conflict (" + this.id + ", " + this.following + ") do nothing";
  ...
  FollowUserRepository.prototype.unfollow = function (id, target) {
    var query1 = "delete from " + this.followerTable + " where " + this.followerId + " = $1 and " + this.follower + "=$2";
    var query2 = "delete from " + this.followingTable + " where " + this.id + " = $1 and " + this.following + "=$2";
  ...
  FollowUserRepository.prototype.checkFollow = function (id, target) {
    var check = "select " + this.id + " from " + this.followerTable + " where " + this.id + " = $1 and " + this.follower + " = $2 ";
    return this.execute([{ query: check, params: [target, id] }]).then(function (count) {
...
var SqlFollowRepository = (function () {
  function SqlFollowRepository(execute, followerTable, followerId, follower, followed_at, followingTable, id, following, following_at, infoTable, infoId, followerCount) {
    this.execute = execute;
    this.followerTable = followerTable;
    this.followerId = followerId;
    this.follower = follower;
  ...
  SqlFollowRepository.prototype.follow = function (id, target) {
    var now = new Date();
    var query1 = "insert into " + this.followerTable + "(" + this.followerId + ", " + this.follower + ", " + this.followed_at + ") values ($1, $2, $3) on conflict (" + this.followerId + ", " + this.follower + ") do nothing";
    var query2 = "insert into " + this.followingTable + "(" + this.id + ", " + this.following + ", " + this.following_at + ") values ($1, $2, $3) on conflict (" + this.id + ", " + this.following + ") do nothing";
  ...
  SqlFollowRepository.prototype.unfollow = function (id, target) {
    var query1 = "delete from " + this.followerTable + " where " + this.followerId + " = $1 and " + this.follower + "=$2";
    var query2 = "delete from " + this.followingTable + " where " + this.id + " = $1 and " + this.following + "=$2";
    var query3 = "\n    update " + this.infoTable + "\n    set " + this.followerCount + " = " + this.followerCount + " - 1\n    where " + this.infoId + " = $1";
    return this.execute([
  ...
  SqlFollowRepository.prototype.checkFollow = function (id, target) {
    var check = "select " + this.id + " from " + this.followerTable + " where " + this.id + " = $1 and " + this.follower + " = $2 ";
    return this.execute([{ query: check, params: [target, id] }]).then(function (count) {
      return count > 0 ? true : false;
    });
...
exports.SqlFollowRepository = SqlFollowRepository;
var ReactRepository = (function () {
  function ReactRepository(db, userreactionTable, id, author, reaction, prefix, suffix, userinfoTable, infoId, reactioncount) {
    this.db = db;
  ...
  ReactRepository.prototype.react = function (id, author, reaction) {
    var _this = this;
    ...
    return this.db.query(sql, [id, author]).then(function (r) {
      if (r.length <= 0) {
        ...
        return _this.db.executeBatch([s1, s2]);
      }
      else {
        ...
        var s2 = { query: query2, params: [id] };
        return _this.db.executeBatch([s1, s2], true);
      }
    });
  };
  ReactRepository.prototype.unreact = function (id, author, reaction) {
  ...
  ReactRepository.prototype.checkReaction = function (id, author) {
    var sql = "select reaction from " + this.userreactionTable + " where " + this.id + " = $1 and " + this.author + " = $2";
    return this.db.query(sql, [id, author]).then(function (r) {
      if (r && r.length > 0) {
        return r[0].reaction;
