...
export function count(client, sql, args) {
  return executeScalar(client, sql, args).then((res) => (res !== null ? Number(res) : 0));
}
...
export function executeBatchWithClientTx(client, statements, requireFirstAffected) {
  return __awaiter(this, void 0, void 0, function* () {
    if (!statements || statements.length === 0) {
      client.release();
      return 0;
      ...
      try {
        return yield execute(client, statements[0].query, statements[0].params);
      }
      finally {
        client.release();
      }
...
export function executeBatchWithClient(client, statements, requireFirstAffected) {
  return __awaiter(this, void 0, void 0, function* () {
    if (!statements || statements.length === 0) {
      return Promise.resolve(0);
    }
