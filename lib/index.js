...
var FollowRepository = (function () {
  function FollowRepository(execute, followingTable, id, following, following_at, followerTable, followerId, follower, followed_at, infoTable, infoId, followerCount, followingCount) {
    this.execute = execute;
  ...
  FollowRepository.prototype.follow = function (id, target) {
    ...
    return this.execute([{ query: double, params: [id, target] }], true).then(function (data) {
      if (data > 0) {
        ...
        var now = new Date();
        var query1 = "insert into " + _this.followingTable + "(" + _this.id + ", " + _this.following + ", " + _this.following_at + ") values ($1, $2, $3) on conflict (" + _this.id + ", " + _this.following + ") do nothing";
        var query2 = "insert into " + _this.followerTable + "(" + _this.followerId + ", " + _this.follower + ", " + _this.followed_at + ") values ($1, $2, $3) on conflict (" + _this.followerId + ", " + _this.follower + ") do nothing";
        var query3 = "\n        insert into " + _this.infoTable + "(" + _this.infoId + "," + _this.followingCount + ", " + _this.followerCount + ")\n        values ($1, 1, 0)\n        on conflict (" + _this.infoId + ") do update set " + _this.followingCount + " =   " + _this.infoTable + "." + _this.followingCount + " + 1";
        var query4 = "\n        insert into " + _this.infoTable + "(" + _this.infoId + "," + _this.followingCount + ", " + _this.followerCount + ")\n        values ($1, 0, 1)\n        on conflict (" + _this.infoId + ") do update set " + _this.followerCount + " = " + _this.infoTable + "." + _this.followerCount + " + 1";
  ...
  FollowRepository.prototype.checkFollow = function (id, target) {
    ...
    return this.execute([{ query: check, params: [id, target] }]).then(function (count) {
